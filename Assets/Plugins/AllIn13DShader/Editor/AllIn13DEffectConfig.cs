...
namespace AllIn13DShader
{
	...
	public class AllIn13DEffectConfig
	{
		...
		public EffectProperty CreateEffectProperty(int propertyIndex, string propertyName, string displayName, ShaderPropertyFlags shaderPropertyFlags,
			EffectPropertyAttributeData data)
		{
			EffectProperty res = new EffectProperty(this, propertyIndex, propertyName, displayName, 
				data.keywordsOp, data.allowReset, shaderPropertyFlags);
